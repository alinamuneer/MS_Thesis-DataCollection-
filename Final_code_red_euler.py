...
def my_handler_rotation_origional(scene):
    ...
    rotation_step=0.1
    rounds=5
    left_fourth_rounds=2
    front_sixth_rounds=2
            ...
            for ob in bpy.context.scene.objects:
                if ob.type == 'CAMERA':
                    for energy in np.arange(0.2,0.9,0.3):
                        ...
                        #saved euler as z y x
                        euler=r.as_euler('zyx', degrees=True)
                        rows = ['-Origional'+'rotation'+str(origional_movement_count_first)+str(origional_movement_count_second)+str(origional_movement_count_third)+str(origional_movement_count_fourth)+str(origional_movement_count_fifth)+str(origional_movement_count_sixth)+'-frame'+str(frames) + '-energy'+str(energy)+ob.name+'depth.png', quarternion_array[0], quarternion_array[1], quarternion_array[2],quarternion_array[3],euler[0],euler[1],euler[2],OGP_transform_matrix_camera[0][3], OGP_transform_matrix_camera[1][3], OGP_transform_matrix_camera[2][3]]
                        with open('./DataCollection-RED-Largedataset-Testing/OGP_dataset_collection_RED.csv', 'a') as csvfile:
        ...
        if origional_movement_count_first==rounds_euler2+1 :
            if origional_movement_count_second==rounds_euler2+1:
                if origional_movement_count_third==rounds+1:
                    if origional_movement_count_fourth==left_fourth_rounds+1:
                        if origional_movement_count_fifth==rounds+1:

                            if origional_movement_count_sixth<front_sixth_rounds:
                                #change the front
                            ...
                            if origional_movement_count_sixth==front_sixth_rounds:
                                bpy.data.objects['Cloth_2'].rotation_euler[0]+=-(rotation_step*front_sixth_rounds)
                                bpy.data.objects['hanger_Collision'].rotation_euler[0]+=-(rotation_step*front_sixth_rounds)
                                bpy.data.objects['hanger_CollisionFree'].rotation_euler[0]+=-(rotation_step*front_sixth_rounds)
                                origional_movement_count_sixth+=1
                    ...
                    if origional_movement_count_fourth<left_fourth_rounds:
                        #change the left
                        ...
                        run_and_stop_animation_rotation_origional()
                    if origional_movement_count_fourth==left_fourth_rounds:
                        bpy.data.objects['Cloth_2'].rotation_euler[1]+=(rotation_step*left_fourth_rounds)
                        bpy.data.objects['hanger_Collision'].rotation_euler[1]+=(rotation_step*left_fourth_rounds)
                        bpy.data.objects['hanger_CollisionFree'].rotation_euler[1]+=(rotation_step*left_fourth_rounds)
                        bpy.data.objects['Cloth_2'].location[2]+=-(location_step_euler1*left_fourth_rounds)
                        bpy.data.objects['hanger_Collision'].location[2]+=-(location_step_euler1*left_fourth_rounds)
                        bpy.data.objects['hanger_CollisionFree'].location[2]+=-(location_step_euler1*left_fourth_rounds)
                        origional_movement_count_fourth+=1
...
def my_handler_rotation_forward(scene):
    ...
    if bpy.context.scene.frame_current ==paus-1:
            ...
            for ob in bpy.context.scene.objects:
                if ob.type == 'CAMERA':
                    for energy in np.arange(0.2,0.9,0.3):
                        ...
                        #print('energy',energy)
                        bpy.context.scene.camera = ob
                        bpy.context.scene.render.filepath = './DataCollection-RED-Largedataset-Training/'+ '-forwardRotation'+str(forward_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name
                        bpy.ops.render.render(use_viewport=False, write_still=True)
                        dmap = get_depth()
                        cv2.imwrite('./DataCollection-RED-Largedataset-Training/'+ '-forwardRotation'+str(forward_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name+'depth.png', dmap * 255)
                        OGP_transform_matrix_camera=np.matmul(np.linalg.inv(bpy.data.objects[ob.name].matrix_world),OGP_transform_matrix_global)
                        #saved quarternions are x y z w
                        r = R.from_matrix([[ OGP_transform_matrix_camera[0][0], OGP_transform_matrix_camera[1][0], OGP_transform_matrix_camera[2][0]],[OGP_transform_matrix_camera[0][1], OGP_transform_matrix_camera[1][1], OGP_transform_matrix_camera[2][1]],[OGP_transform_matrix_camera[0][2], OGP_transform_matrix_camera[1][2], OGP_transform_matrix_camera[2][2]]])
                        quarternion_array=r.as_quat()
                        ...
                        with open('./DataCollection-RED-Largedataset-Training/OGP_dataset_collection_RED.csv', 'a') as csvfile:
                            csvwriter = csv.writer(csvfile)
                            csvwriter.writerow(rows)
        ...
        if forward_rotation_count==rounds:
            print('back to origional hanger position')
...
def my_handler_rotation_backward(scene):
    ...
    if bpy.context.scene.frame_current ==paus-1:
            ...
            for ob in bpy.context.scene.objects:
                if ob.type == 'CAMERA':
                    for energy in np.arange(0.2,0.9,0.3):
                        ...
                        #print('energy',energy)
                        bpy.context.scene.camera = ob
                        bpy.context.scene.render.filepath = './DataCollection-RED-Largedataset-Training/'+ '-backwardRotation'+str(backward_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name
                        bpy.ops.render.render(use_viewport=False, write_still=True)
                        dmap = get_depth()
                        cv2.imwrite( './DataCollection-RED-Largedataset-Training/'+ '-backwardRotation'+str(backward_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name+'depth.png', dmap * 255)
                        OGP_transform_matrix_camera=np.matmul(np.linalg.inv(bpy.data.objects[ob.name].matrix_world),OGP_transform_matrix_global)
                        #saved quarternions are x y z w
                        r = R.from_matrix([[ OGP_transform_matrix_camera[0][0], OGP_transform_matrix_camera[1][0], OGP_transform_matrix_camera[2][0]],[OGP_transform_matrix_camera[0][1], OGP_transform_matrix_camera[1][1], OGP_transform_matrix_camera[2][1]],[OGP_transform_matrix_camera[0][2], OGP_transform_matrix_camera[1][2], OGP_transform_matrix_camera[2][2]]])
                        quarternion_array=r.as_quat()
        ...
        if backward_rotation_count==rounds+1 :
            ...
            bpy.context.scene.frame_set(0)
            bpy.data.objects['Cloth_2'].location[1]+=0.02
            run_and_stop_animation_rotation_forward()
            ...
            for ob in bpy.context.scene.objects:
                if ob.type == 'CAMERA':
                    for energy in np.arange(0.2,0.9,0.3):
                        ...
                        #print('energy',energy)
                        bpy.context.scene.camera = ob
                        bpy.context.scene.render.filepath = './DataCollection-RED-Largedataset-Training/'+ '-backRotation'+str(back_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name
                        bpy.ops.render.render(use_viewport=False, write_still=True)
                        dmap = get_depth()
                        cv2.imwrite('./DataCollection-RED-Largedataset-Training/'+ '-backRotation'+str(back_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name+'depth.png', dmap * 255)
                        OGP_transform_matrix_camera=np.matmul(np.linalg.inv(bpy.data.objects[ob.name].matrix_world),OGP_transform_matrix_global)
                        #saved quarternions are x y z w
                        r = R.from_matrix([[ OGP_transform_matrix_camera[0][0], OGP_transform_matrix_camera[1][0], OGP_transform_matrix_camera[2][0]],[OGP_transform_matrix_camera[0][1], OGP_transform_matrix_camera[1][1], OGP_transform_matrix_camera[2][1]],[OGP_transform_matrix_camera[0][2], OGP_transform_matrix_camera[1][2], OGP_transform_matrix_camera[2][2]]])
                        quarternion_array=r.as_quat()
...
def my_handler_rotation_front(scene):
    ...
    if bpy.context.scene.frame_current ==paus-1:
            ...
            for ob in bpy.context.scene.objects:
                if ob.type == 'CAMERA':
                    for energy in np.arange(0.2,0.9,0.3):
                        ...
                        #print('energy',energy)
                        bpy.context.scene.camera = ob
                        bpy.context.scene.render.filepath = './DataCollection-RED-Largedataset-Training/'+ '-frontRotation'+str(front_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name
                        bpy.ops.render.render(use_viewport=False, write_still=True)
                        dmap = get_depth()
                        cv2.imwrite('./DataCollection-RED-Largedataset-Training/'+ '-frontRotation'+str(front_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name+'depth.png', dmap * 255)
                        OGP_transform_matrix_camera=np.matmul(np.linalg.inv(bpy.data.objects[ob.name].matrix_world),OGP_transform_matrix_global)
                        #saved quarternions are x y z w
                        r = R.from_matrix([[ OGP_transform_matrix_camera[0][0], OGP_transform_matrix_camera[1][0], OGP_transform_matrix_camera[2][0]],[OGP_transform_matrix_camera[0][1], OGP_transform_matrix_camera[1][1], OGP_transform_matrix_camera[2][1]],[OGP_transform_matrix_camera[0][2], OGP_transform_matrix_camera[1][2], OGP_transform_matrix_camera[2][2]]])
                        quarternion_array=r.as_quat()
        ...
        if front_rotation_count==rounds:
            print('back to origional hanger rotation')
            bpy.data.objects['Cloth_2'].rotation_euler[0]+=-(rotation_step*rounds)
            bpy.data.objects['hanger_Collision'].rotation_euler[0]+=-(rotation_step*rounds)
            bpy.data.objects['hanger_CollisionFree'].rotation_euler[0]+=-(rotation_step*rounds)
            ...
            for ob in bpy.context.scene.objects:
                if ob.type == 'CAMERA':
                    for energy in np.arange(0.2,0.9,0.3):
                        ...
                        #print('energy',energy)
                        bpy.context.scene.camera = ob
                        bpy.context.scene.render.filepath = './DataCollection-RED-Largedataset-Training/'+ '-leftRotation'+str(left_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name
                        bpy.ops.render.render(use_viewport=False, write_still=True)
                        dmap = get_depth()
                        cv2.imwrite('./DataCollection-RED-Largedataset-Training/'+ '-leftRotation'+str(left_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name+'depth.png', dmap * 255)
                        OGP_transform_matrix_camera=np.matmul(np.linalg.inv(bpy.data.objects[ob.name].matrix_world),OGP_transform_matrix_global)
                        #saved quarternions are x y z w
                        r = R.from_matrix([[ OGP_transform_matrix_camera[0][0], OGP_transform_matrix_camera[1][0], OGP_transform_matrix_camera[2][0]],[OGP_transform_matrix_camera[0][1], OGP_transform_matrix_camera[1][1], OGP_transform_matrix_camera[2][1]],[OGP_transform_matrix_camera[0][2], OGP_transform_matrix_camera[1][2], OGP_transform_matrix_camera[2][2]]])
                        quarternion_array=r.as_quat()
            ...
            for ob in bpy.context.scene.objects:
                if ob.type == 'CAMERA':
                    for energy in np.arange(0.2,0.9,0.3):
                        ...
                        print('energy',energy)
                        bpy.context.scene.camera = ob
                        bpy.context.scene.render.filepath = './DataCollection-RED-Largedataset-Training/'+ '-RightRotation'+str(Right_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name
                        bpy.ops.render.render(use_viewport=False, write_still=True)
                        dmap = get_depth()
                        cv2.imwrite('./DataCollection-RED-Largedataset-Training/'+ '-RightRotation'+str(Right_rotation_count*rotation_step)+'-location'+str(bpy.data.objects['Cloth_2'].location[1])+'-frame'+str(frames) + '-energy'+str(energy)+ob.name+'depth.png', dmap * 255)
                        OGP_transform_matrix_camera=np.matmul(np.linalg.inv(bpy.data.objects[ob.name].matrix_world),OGP_transform_matrix_global)
                        #saved quarternions are x y z w
                        r = R.from_matrix([[ OGP_transform_matrix_camera[0][0], OGP_transform_matrix_camera[1][0], OGP_transform_matrix_camera[2][0]],[OGP_transform_matrix_camera[0][1], OGP_transform_matrix_camera[1][1], OGP_transform_matrix_camera[2][1]],[OGP_transform_matrix_camera[0][2], OGP_transform_matrix_camera[1][2], OGP_transform_matrix_camera[2][2]]])
                        quarternion_array=r.as_quat()
                        #saved euler as z y x
                        #data is stored as quarternions x y z w then euler z y x and position x y z
                        euler=r.as_euler('zyx', degrees=True)
...
bpy.context.scene.frame_set(0)
bpy.data.objects['Cloth_2'].location[1]+=0.02 #location_step*rounds
#run_and_stop_animation_rotation_origional()
run_and_stop_animation_rotation_left()
