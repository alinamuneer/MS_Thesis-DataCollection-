...
def get_OGP():
    cloth_object_ = bpy.data.objects['Cloth']
    cloth_object = cloth_object_.to_mesh()

    OGP_vertex_location_vector= (cloth_object.vertices[214].co + cloth_object.vertices[1035].co + cloth_object.vertices[1046].co + cloth_object.vertices[1991].co ) / 4
    ...
    cloth_transform_matrix_world = cloth_object.transform(cloth_object_.matrix_world)

    #gripper_approach direction of the face
    gripper_approach_direction=(cloth_object.vertices[214].co - cloth_object.vertices[1035].co) + (cloth_object.vertices[1046].co - cloth_object.vertices[1991].co) / 2
    ...
    face_normal = cloth_object.polygons[858].normal
    ...
    OGP_vertex_global = np.matmul(np.array(cloth_object_.matrix_world), OGP_transform_matrix_local)
